...
import 'package:Nahvino/features/profile/view_profile/controllers/Phoenix_controller.dart';
            ...
            if (phoenix_Controller.phoenixResponse == null)
              Column(
                children: [
                  ...
                  Container(
                      width: 100,
                      child: Image.asset('assets/images/hart/hart-lave1.png')),
                ],
              ),
            if (phoenix_Controller.phoenixResponse != null)
              Card(
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: [
                      ...
                      Container(
                        alignment: Alignment.center,
                        child: ghoghnos[phoenix_Controller.phoenixResponse['data']],
                      ),
                      if (phoenix_Controller.phoenixResponse['data'] > 6)
                        Container(
                            width: 150,
                      ...
                      Container(
                        alignment: Alignment.center,
                        child: hart[phoenix_Controller.phoenixResponse['data']],
                      ),
                    ],
                  ),
                ),
