...
import 'package:Nahvino/features/feature_chat/group/chat_group/widget/menu_chat_group_widght.dart';
import 'package:Nahvino/features/feature_chat/group/info_group/controllers/info_group_controller.dart';
import 'package:Nahvino/features/feature_chat/group/info_group/screen/info_screen.dart';
                              ...
                              InkWell(
                                  ...
                                  child: Row(
                                    children: [
                                      Title2(
                                          color: Colors.white,
                                          text: chat_group_controller
                                                      .appbarname.value.length >
                                                  17
                                      ...
                                      (chat_group_controller
                                                  .appbarimage.value !=
                                              null)
                                          ? img.image(chat_group_controller
                                              .appbarimage.value)
                                          : img.image_assets(),
                                    ],
                                  )),
