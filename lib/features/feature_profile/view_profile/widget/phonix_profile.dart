...
class PhonixProfile extends StatelessWidget {
  ...
  ghgoghnos() {
    if (phoenix_Controller.lastVisitModel!.data! > 6) {
      Lottie.asset('assets/anim/phonix/level7.json');
    } else {
      ghoghnos[phoenix_Controller.lastVisitModel!.data!];
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<PhoenixController>(builder: (logic) {
      return (phoenix_Controller.lastVisitModel == null)
          ? Container(
              color: Colors.white,
              child: Center(
                  ...
                  children: [
                    Container(
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          children: [
                            (phoenix_Controller.lastVisitModel!.data! > 6)
                                ? Container(
