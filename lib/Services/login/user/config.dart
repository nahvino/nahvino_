class Config {
  ...
  static const String apiURL = "https://api.nahvino.ir";
  ...
  static const String checkquestionanswer = "/api/v1/Account/CheckQuestionAnswer";
  ...
  static const String UserSecuritySttingMenus = "/api/v1/Account/UserSecuritySttingMenus";
  static const String AddIntroduced = "/api/v1/Account/AddIntroduced";
  static const String ChangePasswrod = "/api/v1/Account/NotIntroduced";
  ...
  static const String CheckCodeSetPhoneNumber = "/api/v1/Account/CheckCodeSetPhoneNumber";
