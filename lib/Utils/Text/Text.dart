...
class textbold extends StatelessWidget{
  ...
  Widget build(BuildContext context) {
    return Text(text,
      style: TextStyle(
          color: color,
          fontSize: 18, fontFamily: 'Vazirmatn_Light'),);
  }
}
...
class LargeTitle extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Text(text,
      style: TextStyle(
          color: color,
          fontSize: 34, fontFamily: 'vazirlight'),);
  }
}
...
class Title1 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Text(text,
      style: TextStyle(
          color: color,
          fontSize: 28, fontFamily: 'vazirlight'),);
  }
}
...
class Title2 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Text(text,
      style: TextStyle(
          color: color,
          fontSize: 22, fontFamily: 'Vazirmatn_SemiBold'),);
  }
}
...
class Title3 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Text(text,
      style: TextStyle(
          color: color,
          fontSize: 20, fontFamily: 'vazirlight'),);
  }
}
...
class Headline extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Text(text,
      style: TextStyle(
          color: color,
          fontSize: 17,fontWeight: FontWeight.w600, fontFamily: 'vazirlight'),);
  }
}
...
class Body extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Text(text,
      style: TextStyle(
          color: color,
          fontSize: 17, fontFamily: 'Vazirmatn_Regular'),);
  }
}
...
class Callout extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Text(text,
      style: TextStyle(
          color: color,
          fontSize: 16, fontFamily: 'Vazirmatn_Regular'),);
  }
}
...
class Subhead extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Text(text,
      style: TextStyle(
          color: color,
          fontSize: 15, fontFamily: 'Vazirmatn_Medium'),);
  }
}
...
class Caption2 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Text(text,
      style: TextStyle(
          color: color,
          fontSize: 11, fontFamily: 'Vazirmatn_ExtraLight'),);
  }
}